...
def fpn_ResNet18_conv5_body():
    return fpn(
        ResNet.ResNet18_conv5_body, fpn_level_info_ResNet18_conv5()
    )

def fpn_ResNet34_conv5_body():
    return fpn(
        ResNet.ResNet34_conv5_body, fpn_level_info_ResNet34_conv5()
    )
