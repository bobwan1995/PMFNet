...
def process_in_parallel(
        ...
        heatmap_kernel_size, part_crop_size, use_kps17,
        opts=''):
    ...
    for i, gpu_ind in enumerate(gpu_inds):
        ...
        cmd += ' --net_name {net_name} --mlp_head_dim {mlp_head_dim}'
        cmd += ' --heatmap_kernel_size {heatmap_kernel_size} --part_crop_size {part_crop_size}'
